...
public class Game extends JFrame implements ActionListener, MouseListener, MouseMotionListener,MouseWheelListener
{
    ...
    public Game()
    {
      ...
      //  scoreView.setTar
        ...
        timer.start();
        tick.setInterval( timer.getDelay() );
...
////////////////////////////move up////////////////////////////////////////////////////////////
        ...
        imap.put(upKey, "Move up");
        amap.put("Move up",netMoveD);
...
//////////////////////////move down///////////////////////////////////////////////////////////////
        ...
        imap.put(downKey, "Move down");
        amap.put("Move down",netMoveU);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void mousePressed(MouseEvent e) {
        ...
        try {
            mapView.getVTM().inverseTransform(thePoint, thePoint);
        ...
        while(iterator.hasNext() && isPaused()){
          ...
          //  System.out.println(curObj);
            if(curObj instanceof Dog){
                if(((Dog)curObj).contains(thePoint)){
